                    ...
                    Object.keys(userData).map(el=>{
                        return(
                            <div>
                                ...
                                <div className={check ? 'cursor-change dark_text':'cursor-change light_text '} onClick={()=> props.history.push("/detailed-results", {disease: el})} style={{ textAlign: 'right', paddingTop: 10, paddingBottom: '2rem', fontSize: 11.69, display: 'flex',justifyContent: 'flex-end', alignItems:'center' }} >
